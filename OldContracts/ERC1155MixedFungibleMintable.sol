...
contract ERC1155MixedFungibleMintable is ERC1155MixedFungible {
    ...
    function createAndMintNFT( string memory _uri,string memory name,string memory symbol,address[] memory _to) public {
        uint _Type = create(_uri,true,name,symbol);
        mintNonFungible(_Type,to);
